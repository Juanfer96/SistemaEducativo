...
public class VentanaAltasBajasCompetencia extends javax.swing.JFrame {
    ...
    public VentanaAltasBajasCompetencia() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaAltasBajasCompetencia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
