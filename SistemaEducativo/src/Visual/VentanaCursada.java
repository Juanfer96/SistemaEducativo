...
public class VentanaCursada extends javax.swing.JFrame
{
    ...
    public void disable(){
        this.jTextFieldAñoConsulta.disable();
        this.jTextFieldCuatrimestreConsulta.disable();
        this.jTextFieldNombreConsultaa.disable();
        this.jTextFieldIdConsulta.disable();
        this.jListProfesoresConsulta.disable();
        this.jListAlumnosConsulta.disable();
    }
    ...
    private void initComponents()//GEN-BEGIN:initComponents
    {
        ...
        jRadioButton1CAlta.setSelected(true);
        ...
        jButtonAltasBajasAlumnosAlta.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                jButtonAltasBajasAlumnosAltaActionPerformed(evt);
            }
        });
        jPanel8.add(jButtonAltasBajasAlumnosAlta);

        jButtonAltasBajasProfesoresAlta.setText("Altas/Bajas de Profesores");
        jButtonAltasBajasProfesoresAlta.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                jButtonAltasBajasProfesoresAltaActionPerformed(evt);
            }
        });
        jPanel8.add(jButtonAltasBajasProfesoresAlta);

        jButtonAltasBajasHorariosAlta.setText("Altas/Bajas Horarios");
        jButtonAltasBajasHorariosAlta.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                jButtonAltasBajasHorariosAltaActionPerformed(evt);
            }
        });
        ...
        jSpinnerAlta.setModel(new javax.swing.SpinnerNumberModel(17, 17, null, 1));
        ...
        buttonGroup1.add(jRadioButton1CMod);
        jRadioButton1CMod.setSelected(true);
        jRadioButton1CMod.setText("1°Cuatrimestre");
        jPanel19.add(jRadioButton1CMod);

        buttonGroup1.add(jRadioButton2CMod);
        ...
        jButtonAltasBajasAlumnosMod.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                jButtonAltasBajasAlumnosModActionPerformed(evt);
            }
        });
        jPanel22.add(jButtonAltasBajasAlumnosMod);

        jButtonAltasBajasProfesoresMod.setText("Altas/Bajas de Profesores");
        jButtonAltasBajasProfesoresMod.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                jButtonAltasBajasProfesoresModActionPerformed(evt);
            }
        });
        jPanel22.add(jButtonAltasBajasProfesoresMod);

        jButtonAltasBajasHorariosMod.setText("Altas/Bajas Horarios");
        jButtonAltasBajasHorariosMod.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                jButtonAltasBajasHorariosModActionPerformed(evt);
            }
        });
        ...
        jSpinnerMod.setModel(new javax.swing.SpinnerNumberModel(17, 17, null, 1));
        ...
        jPanelConsulta.setBorder(javax.swing.BorderFactory.createTitledBorder("Lista de profesores"));
        ...
        jPanel29.setBorder(javax.swing.BorderFactory.createTitledBorder("Lista de alumnos"));
        ...
        jPanel30.setBorder(javax.swing.BorderFactory.createTitledBorder("Lista de profesores"));
        ...
        jPanelConsultaLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelConsultaLayout.createSequentialGroup()
                ...
                .addGroup(jPanelConsultaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanel28, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 582, Short.MAX_VALUE)
            ...
            .addGroup(jPanelConsultaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanelConsultaLayout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jPanel23, javax.swing.GroupLayout.DEFAULT_SIZE, 582, Short.MAX_VALUE)
                    .addContainerGap()))
            .addGroup(jPanelConsultaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanelConsultaLayout.createSequentialGroup()
                    .addContainerGap()
    ...
    private void jButtonAltasBajasAlumnosAltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAltasBajasAlumnosAltaActionPerformed
        // TODO add your handling code here:
        VentanaAltasBajasAlumnosCursada ventana=new VentanaAltasBajasAlumnosCursada(this.facultad,this);
        ventana.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButtonAltasBajasAlumnosAltaActionPerformed

    private void jButtonAltasBajasHorariosAltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAltasBajasHorariosAltaActionPerformed
        VentanaAltasBajasHorariosCursada ventana=new VentanaAltasBajasHorariosCursada(this.facultad,this);
        ventana.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButtonAltasBajasHorariosAltaActionPerformed

    private void jButtonAltasBajasHorariosModActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jButtonAltasBajasHorariosModActionPerformed
    {//GEN-HEADEREND:event_jButtonAltasBajasHorariosModActionPerformed
        // TODO add your handling code here:
        VentanaAltasBajasHorariosCursada ventana=new VentanaAltasBajasHorariosCursada(this.facultad,this);
        ventana.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButtonAltasBajasHorariosModActionPerformed

    private void jButtonAltasBajasAlumnosModActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jButtonAltasBajasAlumnosModActionPerformed
    {//GEN-HEADEREND:event_jButtonAltasBajasAlumnosModActionPerformed
        // TODO add your handling code here:
        VentanaAltasBajasAlumnosCursada ventana=new VentanaAltasBajasAlumnosCursada(this.facultad,this);
        ventana.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButtonAltasBajasAlumnosModActionPerformed

    private void jButtonAltasBajasProfesoresAltaActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jButtonAltasBajasProfesoresAltaActionPerformed
    {//GEN-HEADEREND:event_jButtonAltasBajasProfesoresAltaActionPerformed
        // TODO add your handling code here:
        VentanaAltasBajasProfesoresCursada ventana=new VentanaAltasBajasProfesoresCursada(this.facultad,this);
        ventana.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButtonAltasBajasProfesoresAltaActionPerformed

    private void jButtonAltasBajasProfesoresModActionPerformed(java.awt.event.ActionEvent evt)//GEN-FIRST:event_jButtonAltasBajasProfesoresModActionPerformed
    {//GEN-HEADEREND:event_jButtonAltasBajasProfesoresModActionPerformed
        // TODO add your handling code here:
        VentanaAltasBajasProfesoresCursada ventana=new VentanaAltasBajasProfesoresCursada(this.facultad,this);
        ventana.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButtonAltasBajasProfesoresModActionPerformed
